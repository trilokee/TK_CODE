...
public class FlightController {
	...
	{
		System.out.println("indise findflights method");
		List<Flight> flights = flightRepository.findFlights(from,to,departureDate);
		modelMap.addAttribute("flightskey", flights);//flightskey will be send to jsp page to show the list of flights
		return "displayFlights";
		
	}
	
	
	//adding flight for admin
